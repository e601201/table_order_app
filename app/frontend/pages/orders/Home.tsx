  ...
  return (
    <>
      ...
      <div className="relative mx-auto max-w-[390px] min-h-screen bg-[#FFF8F0] overflow-hidden" style={{ fontFamily: 'Outfit, sans-serif' }}>
        ...
        <button className="fixed bottom-6 right-6 z-30 flex items-center gap-2.5 px-5 py-3 rounded-full bg-[#E53935] shadow-[0_4px_16px_rgba(229,57,53,0.5),0_2px_4px_rgba(229,57,53,0.25)] hover:bg-[#C62828] transition-colors">
